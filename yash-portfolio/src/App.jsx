...
import { Github, Linkedin, Mail, Server, Database, Cpu, Cloud, Terminal, Globe, ChevronDown, ExternalLink, Code, Box } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <SkillCard 
              ...
              skills={["Node.js & Express.js", "Python (FastAPI)", "RESTful APIs", "Microservices Architecture"]}
            />
            <SkillCard 
            ...
            <SkillCard 
              ...
              skills={["MySQL Optimization", "Connection Pooling", "MongoDB Aggregations", "Data Integrity"]}
            />
            <SkillCard 
              icon={<Cpu size={32} className="text-orange-400" />}
              title="AI Integration"
              skills={["Gemini API Implementation", "OpenCV & InsightFace", "n8n Workflows", "Intelligent Automation"]}
            />
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
                ...
                <a href="tel:+919359126989" className="flex items-center gap-3 px-8 py-4 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-lg text-white transition-all group">
                    <span className="text-blue-400 group-hover:scale-110 transition-transform font-bold">#</span>
                    +91 9359126989
                </a>
            </div>
